...
public class NumbersDriver
{
    ...
    private static void median() {
        ...
        double[]    arr5    = { 1, .5, -2.2, -.3, .5, -.4, 3.2 }; // 0.5
    ...
    private static void factorial() {
    	...
    	// Expected results: 1  1  2  6  120 3,628,800
        int[] nums = {0, 1, 2, 3, 5,  10};   
    ...
    /**
     * Exercises Numbers.bigFactorial( int ).
     * 
     * @see #bigFactorial(int)
     * @see Numbers #bigFactorial(int)
     */
    private static void bigFactorial() {
    	 ...
    	 */
        int[] bigNums = { 0, 1, 3, 21, 23, 25 };   
        for ( int bigNum : bigNums ) {
        	bigFactorial(bigNum);
        }
    }
    
    /**
     * Conv.enience routine to assist testing Numbers.bigFactorial(int).
     * Calls Numbers.bigFactorial(int) with the given number,
     * and prints the test result.
     * 
     * @param bigNum The given number
     * 
     * @see #bigFactorial()
     * @see Numbers # bigFactorial(int)
     */
    private static void bigFactorial(int bigNum) {
    	BigInteger bigFactorial   = Numbers.factorial(BigInteger.valueOf(bigNum));
        System.out.printf( "factorial( %2d ): %,d\n", bigNum, bigFactorial );
    }
}